...
API_key = "92e55b50-1f00-483b-8fbf-3c96bb6f3c91"

def AGcurrent_measures(location_id):
  # Using this API to get the current reading of the device
  locations_URL = f"https://api.airgradient.com/public/api/v1/locations/{location_id}/measures/current?token={API_key}"
